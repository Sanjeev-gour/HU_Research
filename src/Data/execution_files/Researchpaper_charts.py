...
ml_comp = [
    [100, 100, 100, 100,  6.0, 0,   0],          # Overtake (unseen)
    [100, 100, 100, 100, 100, 100, 100],          # Porto (unseen)
    [100, 100, 100, 100, 100, 100, 100],          # Hangar (unseen)
    [100, 100,  35.5, 21.5, 33, 28.5, 64],       # Berlin (unseen)
    [12.5, 100,  9.5,  2,   4.5, 0,   0],        # F Map (unseen)
]
...
b4 = ax.bar(x + w/2, ml_limit,  w, label='Our Method (Leave-One-Out)', color=ML_C,  edgecolor='black', alpha=0.85)
